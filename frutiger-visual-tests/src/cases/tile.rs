...
use frutiger::layout::Options;
use frutiger::render_helpers::xray::XrayPos;
use frutiger::render_helpers::{RenderCtx, RenderTarget};
use frutiger_config::Color;
...
pub struct Tile {
    window: TestWindow,
    tile: frutiger::layout::tile::Tile<TestWindow>,
}
...
impl Tile {
    ...
    pub fn with_window(args: Args, window: TestWindow) -> Self {
        ...
        let mut tile = frutiger::layout::tile::Tile::new(
            window.clone(),
            size.to_f64(),
            1.,
            clock,
