...
use frutiger_config::{CenterFocusedColumn, PresetSize, Struts};
use frutiger_ipc::{ColumnDisplay, SizeChange, WindowLayout};
...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    fn activate_column_with_anim_config(&mut self, idx: usize, config: frutiger_config::Animation) {
    ...
    pub fn add_column(
        ...
        mut column: Column<W>,
        activate: bool,
        anim_config: Option<frutiger_config::Animation>,
    ) {
...
fn compute_toplevel_bounds(
    border_config: frutiger_config::Border,
...
#[cfg(test)]
mod tests {
    use frutiger_config::FloatOrInt;
