...
use frutiger_ipc::{ColumnDisplay, PositionChange, SizeChange, WindowLayout};
...
pub struct Options {
    pub layout: frutiger_config::Layout,
    pub animations: frutiger_config::Animations,
    pub gestures: frutiger_config::Gestures,
    pub overview: frutiger_config::Overview,
    pub blur: frutiger_config::Blur,
    // Debug flags.
...
struct InteractiveMoveData<W: LayoutElement> {
    ...
    pub(self) output_config: Option<frutiger_config::LayoutPart>,
    ...
    pub(self) workspace_config: Option<(WorkspaceId, frutiger_config::LayoutPart)>,
}
...
impl Options {
    ...
    fn with_merged_layout(mut self, part: Option<&frutiger_config::LayoutPart>) -> Self {
